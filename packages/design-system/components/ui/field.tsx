...
function FieldLegend({
  ...
  return (
    <legend
      className={cn(
        "mb-2 font-medium data-[variant=label]:text-base data-[variant=legend]:text-lg",
        className
      )}
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex w-fit items-center gap-2.5 font-medium text-base leading-snug group-data-[disabled=true]/field:opacity-50",
        className
      )}
      data-slot="field-label"
      {...props}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      className={cn(
        "text-left font-normal text-muted-foreground text-base leading-normal group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
        "nth-last-2:-mt-1 last:mt-0",
        "[&>a:hover]:text-primary-accent [&>a]:underline [&>a]:underline-offset-4",
        className
      )}
...
function FieldError({
  ...
  return (
    <div
      className={cn("font-medium text-base text-destructive", className)}
