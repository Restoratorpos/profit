...
/* Collapsed rail still has to be a finger-width column, not a 48px sliver. */
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md p-3 text-left text-base outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-selected data-active:font-medium data-active:text-selected-foreground data-active:hover:bg-selected data-active:hover:text-selected-foreground data-active:[&_svg]:text-selected-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-12! group-data-[collapsible=icon]:p-3! [&>span:last-child]:truncate [&_svg]:size-6 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      // `|| undefined` omits the attribute when inactive. Tailwind v4's
      // `data-active:` variant matches the attribute's *presence*, so
      // data-active="false" would still apply the active background to every
      // item in the menu.
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-hidden ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-selected data-[size=md]:text-sm data-[size=sm]:text-xs data-active:text-selected-foreground data-active:hover:bg-selected data-active:hover:text-selected-foreground group-data-[collapsible=icon]:hidden [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground data-active:[&>svg]:text-selected-foreground",
        className
      )}
      // Same as SidebarMenuButton: the attribute must be absent, not "false".
      data-active={isActive || undefined}
