...
import { useDeleteCombo, useDeleteProduct } from "../api";
import {
...
export const ProductsView = ({
  ...
  const deletingId = deleteProduct.isPending ? deleteProduct.variables : null;
  const deletingComboId = deleteCombo.isPending ? deleteCombo.variables : null;
