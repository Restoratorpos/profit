...
import { formatMoney, readableTextOn } from "@/lib/catalog";
...
export const OrderComposer = ({
  ...
  const handleCheckout = async () => {
    ...
    const result = await createOrderAction({
      ...
      // Only the legs on screen, flattened into what the ledger records: a qarz
      // carrying a part payment becomes that payment plus the balance behind it.
