...
import {
  armFaceCaptureAction,
  captureFaceAction,
  disarmFaceCaptureAction,
  type FacePersonType,
  setFaceAction,
  syncFaceAction,
...
export const FaceDialog = ({
  ...
  const sync = useCallback(
    async ({
      ...
      const result = await syncFaceAction(personType, personId);
  ...
  const capture = async (terminalId: string) => {
    ...
    const result = await captureFaceAction(personType, personId, terminalId);
  ...
  useEffect(() => {
    ...
    const begin = async () => {
      ...
      armFaceCaptureAction(personType, personId);
    ...
    return () => {
      ...
      disarmFaceCaptureAction(personType, personId);
    };
  ...
  const handlePhoto = async (file: File | undefined) => {
    ...
    const result = await setFaceAction(personType, personId, photo);
